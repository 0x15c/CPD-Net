...
class PointRegDataset(Dataset):
    def __init__(self, 
        ...
        if clas==2:
            source=(np.loadtxt('/home/mmvc/mmvc-ny-nas/Lingjing_Wang/AAAI2018/Match3D/hand2.txt')
).reshape(-1,2)
            source=source[:256,:]
            
        if clas==3:
            source=(np.loadtxt('/home/mmvc/mmvc-ny-nas/Lingjing_Wang/AAAI2018/Match3D/human_skeleton.txt')
).reshape(-1,2)
            source=source[:256,:]
            
                    
        if clas==4:
            source=(np.loadtxt('/home/mmvc/mmvc-ny-nas/Lingjing_Wang/AAAI2018/Match3D/skull_try_1.txt')
).reshape(-1,2)
            source=source[:256,:]
            
        if clas==5:
            source=(np.loadtxt('/home/mmvc/mmvc-ny-nas/Lingjing_Wang/AAAI2018/Figures/fork.txt')
).reshape(-1,2)
            source=source[:256,:]
            
        if clas==6:
            source=(np.loadtxt('/home/mmvc/mmvc-ny-nas/Lingjing_Wang/AAAI2018/Figures/face.txt')
).reshape(-1,2)
            source=source[:256,:]
            
        if clas==7:
            source=(np.loadtxt('/home/mmvc/mmvc-ny-nas/Lingjing_Wang/AAAI2018/Figures/mushroom.txt')
).reshape(-1,2)
            source=source[:256,:]
...
#             source=np.asarray(sc)
#             source=(source/source.max()).reshape(-1,2)
